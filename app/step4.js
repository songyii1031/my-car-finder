...
const BudgetSelectScreen = () => {
    ...
    // 보상형 광고 훅
    const { adStatus, isAdReady, error, loadAd, showAd, resetAd, } = useRewardedAd({
        onAdLoaded: () => {
